...
const questions = [
    ...
    "Και που γεννηθήκατε;",
    "Είχατε κατα τη διαρκεια της ζωης σας κάποιο ψευδώνυμο;",
    "Πείτε μερικές γενικές πληροφορίες για εσάς: ",
    "Ποιά είναι η τωρινή σας διεύθυνση κατοικίας;",
    "Ποιά είναι τα ονόματα της οικογένειας σας; (Γονεις, αδερφια, ξαδέρφια)",
    ...
    "Ποια ήταν η διεύθυνση του σπιτιού σας κατά την παιδική σας ηλικία; Μπορείτε να μοιραστείτε πάνω από μια.",
    "Σε ποιά σχολεία πηγαίνατε;",
    "Έχετε κάποιες αναμνήσεις απο τον πρώτο σας έρωτα που θα θέλατε να μοιραστείτε; Γραψτε ελέυθερα.",
    "Εχει μείνει κατι που θα θέλατε να γράψετε σχέτικα με την παιδική σας ηλικία; Μοιραστείτε το εδω.",
    ...
    "Ποιές είναι οι αξίες και τα πιστεύω σας; Μοιραστείτε τα ελευθερα.",
    "Υπάρχουν κάποια επιτεύγματα στη ζωή σας που θα θέλατε να μοιραστείτε;",
    "Ποιά είναι τα αγαπημένα σας φαγητα η/και συνταγές;",
    ...
    "Έχετε καποια αγαπημένη εποχή και αγαπημένο καιρό;",
